...
import (
	...
	"github.com/patya3/notime/pkg/tui/pages/syncModal"
...
func StartTui() {
	...
	pagePrimitive.
		...
		// AddPage("ConfirmationModal", confirmationModal.InitConfirmationModal(pagePrimitive, "ISSUE_LOG"), true, false).
		...
		AddPage("SyncModal", syncModal.InitSyncModal(app, pagePrimitive), true, false).
		AddPage("ConfirmationModal", helpers.ConfirmationModal, true, false)
